...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-gradient-dark z-index-3 py-3">
        <div class="col-md-12">
            <h1 class="text-center" style="color: white;">Liderança: {{ $lider->nome }}</h1>
        </div>
        </div>
    </nav>
                ...
                <div class="col-md-12 mb-lg-0 mb-4">
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-3">
                            <form action="{{ url('/cadastro_publico') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}

                                <input hidden type="text" name="lider_id" value="{{ $lider->id }}" readonly>
                                <div class="row">
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ old('secao') }}" type="text"
                                                name="secao" name="secao" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ old('titulo') }}" type="text"
                                                name="titulo" name="titulo" required>
                                        </div>
                                    </div>
                                </div>

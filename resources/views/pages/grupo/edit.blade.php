                ...
                <div class="col-md-12 mb-lg-0 mb-4">
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-3">
                            <form action="{{ url("grupo/$pessoa->id") }}" method="post" enctype="multipart/form-data">
                                {!! method_field('PUT') !!}
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="d-flex justify-content-center mb-4">
                                            ...
                                            @else
                                                {{-- <img id="selectedAvatar" src="{{ asset('uploads/' . $pessoa->foto) }}" --}}
                                                <img id="selectedAvatar" src="{{ $path_file_storage . $pessoa->foto }}"
                                                    class="rounded-circle"
                                                    style="width: 200px; height: 200px; object-fit: cover;"
                                                    alt="example placeholder" />
                                            @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="example-text-input" class="form-control-label"><b style="color: red">*</b>
                                                        Nome</label>
                                                    <input class="form-control" value="{{ $pessoa->nome }}" type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" value="{{ $pessoa->apelido }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="example-text-input" class="form-control-label">
                                                        Email</label>
                                                    <input class="form-control" value="{{ $pessoa->email }}" type="email"
                                                        name="email">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="example-text-input" class="form-control-label"><b style="color: red">*</b>
                                                        Celular</label>
                                                    <input class="form-control" value="{{ $pessoa->telefone }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" value="{{ $pessoa->nascimento }}"
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ $pessoa->cep }}" type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ $pessoa->rua }}" type="text"
                                                name="rua" id="rua" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ $pessoa->municipio }}" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ $pessoa->bairro }}" type="text"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ $pessoa->numero }}" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tipo" id="tipo">
                                                ...
                                                <option @if ($pessoa->tipo === 'colaborador') selected @endif
                                                    value="Colaborador">Colaborador</option>
                                                <option @if ($pessoa->tipo === 'lideranca') selected @endif
                                                    value="lideranca">Liderança</option>
                                                <option @if ($pessoa->tipo === 'indeciso') selected @endif value="indeciso">
                                                    Indeciso</option>
                                    ...
                                    @if ($pessoa->tipo === 'colaborador')
                                        <div class="col-md-5" id="showdivlider">
                                            <div class="form-group">
                                                <label for="example-text-input"
                                                    class="form-control-label">Liderança</label>
                                                <select name="lider_id" id="lider_id">
                                                    <option value=""></option>
                                                    @foreach ($lideres as $lider)
                                                        @if ($lider->id == $pessoa->lider_id)
                                                            <option value="{{ $pessoa->lider_id }}" selected>
                                                                {{ $lider->nome }}</option>
                                                        @endif
                                    ...
                                    @else
                                        <div class="col-md-3" id="showdivlider" style="display: none">
                                            <div class="form-group">
                                                <label for="example-text-input"
                                                    class="form-control-label">Liderança</label>
                                                <select name="lider_id" id="lider_id">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input id="zona" class="form-control" value="{{ $pessoa->zona }}" type="text"
                                                name="zona" name="zona">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input id="secao" class="form-control" value="{{ $pessoa->secao }}" type="text"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input id="titulo" class="form-control" value="{{ $pessoa->titulo }}" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ $pessoa->facebook }}" type="text"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ $pessoa->instagram }}" type="text"

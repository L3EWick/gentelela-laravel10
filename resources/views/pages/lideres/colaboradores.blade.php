                        ...
                        <div class="card-header pb-0 p-3">
                            <div class="row">
                                <div class="col-6 d-flex align-items-center">
                                    <h6 class="mb-0">Colaboradores do {{ $lider->nome }}</h6>
                                </div>
                                <div class="col-6 text-end">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                                        <li>
                                            <a class="dropdown-item" href="{{url("/grupo/export_colaboradores_lider_excel/$lider->id")}}" target="_blank">
                                            ...
                                            @foreach ($colaboradores as $colaborador)
                                                <tr>
                                                        ...
                                                        <div class="d-flex px-2 py-1">
                                                            <div>
                                                                @if (isset($colaborador->foto))
                                                                    {{-- <img src="{{ asset('uploads/' . $colaborador->foto) }}" --}}
                                                                        <img src="{{ $path_file_storage . $colaborador->foto }}" 
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-xs">{{ $colaborador->nome }}</h6>
                                                                <p class="text-xs text-secondary mb-0">
                                                                    {{ $colaborador->telefone }}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0">{{ $colaborador->bairro }}
                                                        </p>
                                                        {{-- <p class="text-xs text-secondary mb-0">Organization</p> --}}
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="text-secondary text-xs font-weight-bold">
                                                            @if (isset($colaborador->zona))
                                                                {{ $colaborador->zona }} /
                                                            @else
                                                                -- /
                                                            @endif

                                                            @if (isset($colaborador->secao))
                                                                {{ $colaborador->secao }}
                                                            @else
                                                                --
                                                            @endif
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold">
                                                            @isset($colaborador->facebook)
                                                                <a type="button"
                                                                href="https://www.facebook.com/{{$colaborador->facebook}}"
                                                                target="_blank" 
                                                            ...
                                                            @endisset
                                                            @isset($colaborador->instagram)
                                                                <a type="button"
                                                                    href="https://www.instagram.com/{{$colaborador->instagram}}"
                                                                    target="_blank" 
                                                            ...
                                                            @endisset
                                                            @isset($colaborador->telefone)
                                                                <a type="button"
                                                                    href="https://wa.me/55{{ $colaborador->telefone }}"
                                                                    target="_blank" 
                                                    ...
                                                    <td class="align-middle  text-center">
                                                        <a id="btn_editar_pessoa"
                                                                ...
                                                                href="{{ url("/grupo/$colaborador->id/edit") }}"
                                                                title="Edita Pessoa">
                                                            ...
                                                            <a class="btn btn-danger btn-xs action botao_acao btn_delete"
                                                                data-delete="{{ $colaborador->id }}" data-toggle="tooltip"
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("body").on("click", "a.btn_delete", function(e) {
                    ...
                    swal({
                        title: "Atenção!",
                        text: 'Você esta prestes a EXCLUIR um Paciente',
                        icon: "warning",
                        buttons: {
                            cancel: {
                                text: "Cancelar",

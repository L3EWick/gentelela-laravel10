    ...
    <div class="container position-sticky z-index-sticky top-0">
        <div class="row">
            <div class="col-12">
                ...
                @if(session('alertaLicenca'))
                <script>
                    Swal.fire({
                        title: 'Atenção!',
                        text: '{{ session('alertaLicenca') }}',
                        icon: 'warning',
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    <h4 class="font-weight-bolder">Template ultraCode</h4>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        <div class="text-center">
                                            <button style="background-color: #098847 !important" type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Entrar</button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-6 d-lg-flex d-none h-100 position-absolute top-0 end-0 text-center justify-content-center flex-column">
                            <div class="position-relative h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="width: 85%;">
                                <img src="{{ asset('img/logo_cliente/logo.jpg') }}" alt="Logo" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>

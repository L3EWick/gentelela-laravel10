	...
	<body class="nav-md">
		<div class="container body" >
			<div class="main_container">
						...
						<div class="navbar nav_title" style="border: 0; text-align: center">
							...
							<a href="{{ route('home')}}" class="site_title">
								<div class="profile_pic">
									<img src="{{asset('img/uc-logo256.png')}}" alt="..."  height="55">
								</div>

								<span style="color: #ffffff; ">Gerencia</span>
				...
				<footer>
					<div >
						© 2024 <a href="https://ultracode.com.br/" target="_blank"><i style=" color:black" class="fab fa-free-code-camp"></i></a>ultraCode 
					</div>
					<div class="clearfix"></div>
				</footer>
			</div>
